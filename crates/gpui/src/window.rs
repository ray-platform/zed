...
impl Window {
    ...
    pub fn paint_layer<R>(&mut self, bounds: Bounds<Pixels>, f: impl FnOnce(&mut Self) -> R) -> R {
        ...
        let clipped_bounds = self
            .transform_scaled_bounds(self.cover_bounds(bounds))
    ...
    pub fn paint_quad(&mut self, quad: PaintQuad) {
        ...
        self.next_frame.scene.insert_primitive(Quad {
            ...
            content_mask: self.paint_content_mask(),
    ...
    pub fn paint_surface(&mut self, bounds: Bounds<Pixels>, image_buffer: CVPixelBuffer) {
        ...
        let bounds = self.transform_scaled_bounds(self.snap_bounds(bounds));
        let content_mask = self.paint_content_mask();
...
pub struct PaintQuad {
    ...
    /// The paint of the quad's borders.
...
impl PaintQuad {
    ...
    /// Sets the border paint of the quad.
...
pub fn outline(
    ...
    PaintQuad {
        ...
        border_color: border_color.into().into(),
        border_style,
    }
}
